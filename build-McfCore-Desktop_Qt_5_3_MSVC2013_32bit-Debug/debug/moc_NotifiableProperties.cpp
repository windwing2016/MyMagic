...
struct qt_meta_stringdata_Mcf__StringProperty_t {
    QByteArrayData data[8];
    char stringdata[101];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Mcf__StringProperty_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Mcf__StringProperty_t qt_meta_stringdata_Mcf__StringProperty = {
    {
...
QT_MOC_LITERAL(7, 77, 23)
    ...
    "Mcf::StringProperty\0ValueChanged\0\0"
    "value\0SetValue\0MCF_STRING\0const MCF_TCHAR*\0"
    "SetValueNoChangeSignals"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Mcf__StringProperty[] = {
...
void Mcf::StringProperty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->SetValue((*reinterpret_cast< const MCF_STRING(*)>(_a[1]))); break;
        case 3: _t->SetValue((*reinterpret_cast< const MCF_TCHAR*(*)>(_a[1]))); break;
        case 4: _t->SetValueNoChangeSignals((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
...
const QMetaObject Mcf::StringProperty::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Mcf__StringProperty.data,
      qt_meta_data_Mcf__StringProperty,  qt_static_metacall, 0, 0}
};


const QMetaObject *Mcf::StringProperty::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Mcf::StringProperty::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Mcf__StringProperty.stringdata))
        return static_cast<void*>(const_cast< StringProperty*>(this));
    return QObject::qt_metacast(_clname);
}

int Mcf::StringProperty::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QObject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
// SIGNAL 0
void Mcf::StringProperty::ValueChanged(const QString & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
