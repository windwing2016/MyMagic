...
const QMetaObject LoginFrame::staticMetaObject = {
    { &HmiFrame::staticMetaObject, qt_meta_stringdata_LoginFrame.data,
      qt_meta_data_LoginFrame,  qt_static_metacall, 0, 0}
};
...
void *LoginFrame::qt_metacast(const char *_clname)
{
    ...
    return HmiFrame::qt_metacast(_clname);
}

int LoginFrame::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = HmiFrame::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
